...
np.save('trnEBPL2sh',torch.squeeze(traincorr_avg_EBP).numpy())
np.save('trnMVGL2sh',torch.squeeze(traincorr_avg_MVG).numpy())
np.save('testEBPL2sh',torch.squeeze(testcorr_avg_EBP).numpy())
np.save('testMVGL2sh',torch.squeeze(testcorr_avg_MVG).numpy())
